...
// }
// const app = document.querySelector(".app");
// function addFruitList(fruitList) {
//   const ul = document.createElement("ul");
//   fruitList.forEach(function (fruit) {
//     ul.append(addFruitItem(fruit));
//   });

//   app.append(ul);
// }

// addFruitList(fruitList);

// const app = document.querySelector(".app");
// const ul = document.createElement("ul");
// let li = fruitList.map(function (fruit) {
//   return `<li>${fruit}</li>`;
// });
// li = li.join(" ");
// ul.innerHTML = li;
...
// function creatThumbnail(imgSrc, alt) {
...
// function createMeta(title, price) {
...
//   link.append(creatThumbnail(product.image, product.title));
//   link.append(createMeta(product.title, product.price));
...
//   productList.append(creatProduct(product));
// });
